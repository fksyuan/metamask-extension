...
/**
 * Checks whether a given balance of ATP, represented as a hex string, is sufficient to pay a value plus a gas fee
 *
 ...
 * @param {string} txParams.value The value of ATP to send
 * @param {string} hexBalance - A balance of ATP represented as a hex string
